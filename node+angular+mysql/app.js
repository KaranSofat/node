...
app.post('/user/answer/', user.answer);
app.get('/user/showAnswer/:id', user.showAnswer);
app.get('/user/deleteQ/:id', user.deleteQ);
app.get('/user/showQuestion/:id', user.showQuestion);
...
app.get('/like/:id/:userId', user.like);
